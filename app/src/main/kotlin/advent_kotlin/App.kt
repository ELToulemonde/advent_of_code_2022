...
fun main() {
    ...
    // Day 5
    val dataLoader = DataLoader("data/day5.txt")
    val cratesMoves = dataLoader.readMoves()
    val cratesStacks = dataLoader.readCratesStack()
    ...
    // Part 2
    val cratesStacks_part2 = dataLoader.readCratesStack()
    cratesMoves.forEach { move ->
